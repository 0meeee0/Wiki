...
<div class="container">
	<div class="row">
		...
		<?php 
			$query = "SELECT category_name FROM categories JOIN wikis on wikis.category_id = categories.category_id"
		?>
		<!-- Begin Post -->
		<div class="col-md-8 col-md-offset-2 col-xs-12">
			<div class="mainheading">
				...
				<h1 class="posttitle"><?php echo $shi["title"]?></h1>
